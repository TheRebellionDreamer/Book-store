  ...
  return (
    <form className={classes.container}>
      ...
      <Container className={classes.inputContainer}>
        ...
        />
        <Snackbar open={emailSnackbarIsOpen} autoHideDuration={2000} onClose={handleEmailClose}>
          <Alert onClose={handleEmailClose} severity="success">Email is confirmed</Alert>
        </Snackbar>
        <TextField
          name="password"
          variant="outlined"
          ...
          value={password}
        />
        <Snackbar open={passwordSnackbarIsOpen} autoHideDuration={2000} onClose={handlePasswordClose}>
          <Alert onClose={handlePasswordClose} severity="success">Password is strong</Alert>
        </Snackbar>
      </Container>
      <Button type="submit" disabled={!formValid}>Registred</Button>
    </form>
  );
};
